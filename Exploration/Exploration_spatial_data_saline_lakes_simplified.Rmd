...
* HUC08 and HUC12 catchment boundary shapefiles attached to our lake boundaries 
...
NHD (high resolution/non-high resolution) will used for the majority of spatial data gathering for our focal saline lakes.

**Notes on specific lakes:** 

* Lake Winnemucca, NV is not available in high resolution NHD database. Spatial data for this lake was therefore retrieved from non-high res NHD.

* 'Warner Lake' looks to be in fact a collection chain of 12 shallow lakes in South East Oregon. This needs to be confirmed. 

* Carson Sink does not exist in any of our databases. It's point location has been added to the lake map below. The spatial data for the Carson Sink will likely be handled separately.  
...
#### Map of HUC08 (green) HUC08 (red) regions surrounding focal lakes
