...
p1_feeback_xlsx_targets_list <- list(
  ...
  tar_target(
    p1_huc_boundary_xwalk_df, 
    create_huc_verification_table(huc10_sf = p1_lakes_huc10_sf,
                                  huc10_name_col = 'Name',
                                  huc8_sf = p1_lakes_huc8_sf,
                                  huc8_name_col = 'Name',
                                  huc6_sf = p1_lakes_huc6_sf,
                                  huc6_name_col = 'Name',
  ...
  tar_target(
    p1_lake_huc6_huc8_huc10_structure_outpath, '1_build_raw_feedback_xlsx/out/lake_huc6_huc8_huc10_structure_table.xlsx'),
  
  tar_target(
    p1_lake_huc6_huc8_huc10_structure_xlsx,
    create_worksheet(df_to_export_as_wb = p1_huc_boundary_xwalk_df,
                     worksheet_name = 'Lake_huc6_huc8_huc10',
                     manual_cols_to_add = 'Part of Watershed (Yes/No)',
                     out_file = p1_lake_huc6_huc8_huc10_structure_outpath),
    format = 'file'
  )
)
