...
### X
## List of lakes
lakes_excel <- readxl::read_xlsx('Exploration/Data/Lakes_list.xlsx', col_types = 'text')
...
### X
# States
states <- st_read('Exploration/Data/statesp010g.shp_nt00938/statesp010g.shp') %>%
...
nhdhr_dir <- 'Exploration/Data/temp_hr_lakes'
