...
* Carson Sink does not exist in any of our databases. A point location has been added to the lake map below indicate our best estimate of the location of Carson Sink.
The spatial data for the Carson Sink will likely be handled separately.  
...
## Handling Warner lakes/wetland which is made u of collection of shallow wetland lakes
...
leaflet(lakes_map) %>%
  ...
  addLegend("bottomright",
           colors = c('red','darkblue'), labels = c('HUC08 boundary','flowlines'),
    title = "Legend",
    opacity = 1
  )
